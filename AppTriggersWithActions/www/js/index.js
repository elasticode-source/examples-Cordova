...
var app = {
    ...
    onDeviceReady: function() {
        ...
        // Adding listener for the button
        ...
        params.data.defineAppTrigger("appTriggerWithActions", function(active){  });
        
        // Set actions, you need to select the action from the studio
        window.elasticode.setActions({
                                     "action1" : function (context){
...
function show()
{   // Show app trigger
    window.elasticode.showAppTrigger("appTriggerWithActions");
}

